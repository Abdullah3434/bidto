                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form name="myForm" action="{{url('/admin/edit/color/'.$ifexist->id)}}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                ...
                                <div class="form-group" >
                                    ...
                                    <input type="text" class="form-control " name="color_name" value="{{$ifexist->color_name}}">
