                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form name="myForm" action="{{url('/admin/edit/request/'.$ifexist->id.'/'.$ifexist->item_type)}}" method="post" enctype="multipart/form-data" onclick="return validateForm()">
                                    @csrf
                                ...
                                <div class="form-group" >
                                    <label for="exampleInputEmail1">Item From Price </label>
                                    <div class="form-group{{ $errors->has('item_from_price') ? ' has-error' : '' }}">
                                    <input type="number" onchange="return validateForm2()" id="text1" class="form-control" name="item_from_price" value="{{$ifexist->item_from_price}}" >
                                    
                                    @if ($errors->has('item_from_price'))
                                        <span class="help-block">
                                            <strong>{{ $errors->first('item_from_price') }}</strong>
                                        </span>
                                    @endif
                                    </div>
                                </div>
                                ...
                                <div class="form-group" >
                                    <label for="exampleInputEmail1">Item to Price </label>
