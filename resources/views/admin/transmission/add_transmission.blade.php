                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form name="myForm" action="{{url('/admin/add/transmission')}}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                ...
                                <div class="form-group" >
                                    ...
                                    <input type="text"  class="form-control " name="transmission_name" placeholder="Transmission Name" value="{{ old('transmission_name') }}">
