...
return [
    ...
    */
    ...
    'You can not do bid on this ad.' => 'You can not do bid on this ad.',
    ...
    "Service has been added successfully." => "Service has been added successfully.",
     ...
     "Device has been saved successfully." => "Device has been saved successfully.",
     "Your account is not active yet." => "Your account is not active yet.",
     "You are not registered with us, please proceed to register."=>"You are not registered with us, please proceed to register.",
    "Your email has already exist  in our system." => "Your email has already exist in our system.",
    "Your email has already exist." => "Your email has already exist.",

    "You have successfully got promotion." => "You have successfully got promotion.",
    "You haven't enough balance to get this promotion." => "You haven't enough balance to get this promotion.",
    "Your account does not exist in our system." => "Your account does not exist in our system.",
    "You need to purchase promotion offer." => "You need to purchase promotion offer.",
    "Amount has been added successfully." => "Amount has been added successfully.",
    "Selected image has been deleted." => "Selected image has been deleted.",
    "Requested Ad does not exist in our system." =>"Requested Ad does not exist in our system.",
    "Item has been extended successfully." => "Item has been extended successfully.",
    "Service has been extended successfully." => "Service has been extended successfully.",
    "Request has been extended successfully." => "Request has been extended successfully.",
    ...
    "Request has been updated successfully." => "Request has been updated successfully.",
];
