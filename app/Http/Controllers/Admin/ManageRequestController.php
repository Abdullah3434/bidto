...
class ManageRequestController extends Controller
{
    ...
    public function view_requests() 
        {     
            ...
            return view('admin.item_request.view_items' , compact('all_items'));
        }  
    ...
    public function edit_request_view($id) 
        {
            ...
            $all_model = ItemModel::select('*')
                ->where('id', '!=', $ifexist->item_model_id)
                ->get();
            ...
            return view('admin.item_request.edit_item' , compact('ifexist','find_makee','find_make_id','is_promoted','is_promotion','all_color_exterior','find_exterior_color_name','find_exterior_color_id',
    ...
    public function edit_request(Request $request,$id,$type)
        {
            if($type=='request' ){
                $rules = [
                ...
                $update['item_from_price'] = $input['item_from_price'];
                $update['item_to_price'] = $input['item_to_price'];
                $update['item_type_key'] = '0';
                $update['category_key'] = '0';
                $update['item_make_id'] = '0';
                $update['item_model_id'] = '0';
                $update['item_condition_id'] = '0';
                $update['item_exterior_color_id'] = '0';
                $update['item_interior_color_id'] = '0';
                $update['item_transmission_id'] = '0';
                $update['item_cylinder_id'] ='0';
                $update['item_year'] = '0';
                $update['item_location'] = $input['item_location'];
                Item::where('id', $id)->update($update); 
            }
            
            Session::flash('success', 'Request Edited!'); 
    ...
    public function view_images($id) 
        {
            ...
            return view('admin.item_request.view_images' , compact('all_images'));
        }  
    ...
    public function view_bids($id) 
        {
            ...
            return view('admin.item_request.view_bids' , compact('all_bids'));
        } 
    public function edit_bid_view($id) 
        {
            ...
            return view('admin.item_request.edit_bid' , compact('ifexist','user','item'));
        } 
    ...
    public function edit_bid(Request $request,$id,$item_id)
        {
            ...
            return redirect('/admin/request/bids/'.$item_id);
        }
