...
class ManageServiceController extends Controller
{
    public function view_services() 
        {
            ...
            return view('admin.item_service.view_items' , compact('all_items'));
        }  
    ...
    public function edit_item_view($id) 
        ...
        //........... Item Cylinder.........//
            ...
            return view('admin.item_service.edit_item' , compact('ifexist','find_makee','find_make_id','is_promoted','is_promotion','all_color_exterior','find_exterior_color_name','find_exterior_color_id',
    ...
    public function edit_item(Request $request,$id,$type)
        {
            // return $type;
            // return $input = $request->input('item_make_id');
            if($type=='service')
                {
                    $rules = [
                        'item_name' => 'required',
                    ...
                    $update['item_to_price'] = '0';
                    $update['item_promotion_price'] = '0';
    ...
    public function view_images($id) 
        {
            ...
            return view('admin.item_service.view_images' , compact('all_images'));
        }  
    ...
    public function view_bids($id) 
        {
            ...
            return view('admin.item_service.view_bids' , compact('all_bids'));
        } 
    public function edit_bid_view($id) 
        {
            ...
            return view('admin.item_service.edit_bid' , compact('ifexist','user','item'));
        } 
    ...
    public function edit_bid(Request $request,$id,$item_id)
        {
            ...
            return redirect('/admin/service/bids/'.$item_id);
        }
