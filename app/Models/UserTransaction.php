...
class UserTransaction extends Model
{
     ...
     */
    protected $fillable = [
        'user_id', 'item_id', 'amount', 'transaction_type'
    ];
     ...
     * @var array
     */
    protected $appends = ['ios_transaction_id', 'added_date_format', 'updated_date_format'];
    ...
    public function getIosTransactionIdAttribute()
    {
