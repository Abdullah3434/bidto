...
class ItemTransmission extends Model
{
    /**
     ...
     * @var array
     */
    protected $appends = ['ios_transmission_id', 'added_date_format', 'updated_date_format'];
    ...
    public function getIosTransmissionIdAttribute()
    {
