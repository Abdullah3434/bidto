...
class ItemModel extends Model
{
     ...
     * @var array
     */
    protected $appends = ['ios_model_id', 'added_date_format', 'updated_date_format'];
    ...
    public function getIosModelIdAttribute()
    {
    ...
    public function make()
     {
         return $this->belongsTo(ItemMake::class,'make_id');
     }
}
